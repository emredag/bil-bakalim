    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">🧪 Tauri Word Selection Test</h1>
          <p className="text-gray-600 mb-6">Direct Tauri backend testing - Task 13</p>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-800">
              <strong>💡 Note:</strong> This test runs directly in Tauri app. If you see "Tauri is
              not available" error, make sure you're running:
